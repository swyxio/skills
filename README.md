...
| Harden database migrations and data cutovers | [database-migration-hardening](./database-migration-hardening) | [cloudflare-production-builder](./cloudflare-production-builder) for platform-specific execution, then [release-readiness-hardening](./release-readiness-hardening) for final gates |
  ...
  <tr>
    ...
    <td valign="middle">
      ...
      <ul>
        ...
        <li><a href="./database-migration-hardening">database-migration-hardening</a> — <strong>Data safety and cutover hardening.</strong> Adds schema/data parity planning, migration manifests, canary credentials, staged cutover, and rollback evidence to prevent silent data corruption.</li>
